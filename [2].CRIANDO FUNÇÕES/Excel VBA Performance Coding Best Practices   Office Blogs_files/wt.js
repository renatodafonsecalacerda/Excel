...
// Version: 8.6.2
// MS Version: 3.2.OfficeBlogs
// Tag Builder Version: 3.0
// Created: 10/21/2009
// Mod: 06/26/13 - dcsJavaScript
    ...
    if (evt && ((typeof (evt.which) != "number") || (evt.which == 1))) {
        ...
        if (e.href && e.protocol) {
            ...
            if (e.protocol.toLowerCase() == "javascript:") {
                // try and pick up title text
                var titlebox = document.getElementById("ctl00_ctl00_OuterTaskRegion_TaskRegion_TaskRegion_CreatePost_ctl06_PostSubject");
                if (titlebox.value) { this.WT.rss_a = titlebox.value; }
