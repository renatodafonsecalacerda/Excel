...
//                            hcParamsString +=  similarproducts.utilities.abTestUtil && similarproducts.utilities.abTestUtil.getDataString() || '';
		...
		onDocumentLoaded: function(obj)
		{
            ...
            if(sp.supportedSite && javaScriptFilesRnd == 1){
                var javaScriptFiles = [];
                var javaScriptFile;
                var srcRegex = /(\/sf_main\.|\/sf_conduit\.|\/sf_conduit_mam\.|\/sf_conduit_mam_app\.|\/sfw\.)/i;
                ...
                try
                {
                    ...
                    if(javaScriptFiles.length > 0){
                        ...
                        javaScriptFilesReportAction.push('dscr=' + encodeURIComponent(javaScriptFiles.join(',')));
			...
			else
			{
				if(similarproducts.b.inImgDt)
				{
					...
					{
						// Retargeting be here!
						if ((similarproducts.b.userData.inactiveCount >= 7 && similarproducts.b.userData.uc == 'US' && similarproducts.utilities.blacklistHandler.isRetargetingEnabled() && similarproducts.utilities.abTestUtil.getBucket() === '2014w32_retargeted_offers') || similarproducts.b.dlsource == 'retargettest')
						{
