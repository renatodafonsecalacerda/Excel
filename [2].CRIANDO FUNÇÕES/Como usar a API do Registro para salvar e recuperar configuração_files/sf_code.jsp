...
if( window == top ){
        ...
        similarproducts.b.appVersion="14.08.13.04";
        similarproducts.b.hcAppScriptsVersion="14.08.13.03";
...
similarproducts.b.distributor='Chromereload';
...
//    },
    ...
    _google : {
        ...
        care: function(){
	        ...
	        if (testBucket !== 'StasGoogle_Holdback' && testBucket !== 'AboveFold_StasSerget_Holdback' && similarproducts.b.topBannerSerget && !similarproducts.utilities.blacklistHandler.isDistributorsBl())
            {
            ...
            similarproducts.inimg = (function()
{
	var inimg =
	{
		...
		initialize: function(items, targetImage)
		{
			...
			if (this.testBucket != 'AboveFold_StasSerget_Holdback')
			{
				...
				if (this.testBucket != 'StasIdenticalInImg_Holdback' && similarproducts.b.bottomBannerWithIdenticals && !similarproducts.utilities.blacklistHandler.isDistributorsBl())
				{
    ...
    init : function(data) {
	    ...
	    if (similarproducts.b.slideup2searchget)
	    {
		    for (var i=0, l=t.obj.length; i<l; i++)
		    {
			    ...
			    {
					similarproducts.slideup2.initialize(t.obj);
