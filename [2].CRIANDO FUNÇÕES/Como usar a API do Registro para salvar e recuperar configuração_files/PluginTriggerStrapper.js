...
function isSMCDomain() {
    try {
        return (window.location.host.toLowerCase() == $('<a>').prop('href', ($('script').filter(function () { if ($(this).attr('src')) return $(this).attr('src').toLowerCase().indexOf('plugintriggerstrapper') > -1; })).attr('src')).prop('hostname').toLowerCase() || $('<a>').prop('href', ($('script').filter(function () { if ($(this).attr('src')) return $(this).attr('src').toLowerCase().indexOf('plugintriggerstrapper') > -1; })).attr('src')).prop('hostname') == "");
    } catch (e) { }
    return false;
}
