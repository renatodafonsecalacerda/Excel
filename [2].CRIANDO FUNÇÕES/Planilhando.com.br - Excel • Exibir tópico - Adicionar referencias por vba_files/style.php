...
.bg1	{ background-color: #eef5f1; }
.bg2	{ background-color: #e4efe9;  }
.bg3	{ background-color: #cfe6da; }
...
a:link	{ color: #23764a; }
a:visited	{ color: #23764a; }
a:hover	{ color: #d34c11; }
a:active	{ color: #4fb982; }
...
/* a.forumtitle:visited { color: #23764a; } */
...
/* a.topictitle:visited { color: #4fb982; } */
...
.postlink {
	color: #4fb982;
	border-bottom-color: #4fb982;
}

.postlink:visited {
	color: #6cae8d;
	border-bottom-color: #6cae8d;
}
...
.syntaxbg		{ color: #FFFFFF; }
.syntaxcomment	{ color: #ff7a00; }
.syntaxdefault	{ color: #0c3faf; }
.syntaxhtml		{ color: #000000; }
.syntaxkeyword	{ color: #007700; }
.syntaxstring	{ color: #dd7a00; }
...
.pollbar1 {
	...
	border-bottom-color: #743416;
	border-right-color: #743416;
}

.rtl .pollbar1 {
	border-left-color: #743416;
}

.pollbar2 {
	background-color: #be4a1e;
	border-bottom-color: #8c3e1c;
	border-right-color: #8c3e1c;
}

.rtl .pollbar2 {
	border-left-color: #8c3e1c;
}

.pollbar3 {
	background-color: #d14b1a;
	border-bottom-color: #aa4a23;
	border-right-color: #aa4a23;
}

.rtl .pollbar3 {
	border-left-color: #aa4a23;
}

.pollbar4 {
	background-color: #e44a16;
	border-bottom-color: #be4a1e;
	border-right-color: #be4a1e;
}

.rtl .pollbar4 {
	border-left-color: #be4a1e;
}

.pollbar5 {
	background-color: #f84a11;
	border-bottom-color: #d14b1a;
	border-right-color: #d14b1a;
}

.rtl .pollbar5 {
	border-left-color: #d14b1a;
}
...
/* Share On 1.2.0 */
.facebook-icon, .facebook-icon a	{ background-image: url("./styles/prosilver/imageset/en/share_on_buttons/shareon_facebook.png"); }
.twitter-icon, .twitter-icon a		{ background-image: url("./styles/prosilver/imageset/en/share_on_buttons/shareon_twitter.png"); }
.tuenti-icon, .tuenti-icon a		{ background-image: url("./styles/prosilver/imageset/en/share_on_buttons/shareon_tuenti.png"); }
.sonico-icon, .sonico-icon a		{ background-image: url("./styles/prosilver/imageset/en/share_on_buttons/shareon_sonico.png"); }
.friendfeed-icon, .friendfeed-icon a	{ background-image: url("./styles/prosilver/imageset/en/share_on_buttons/shareon_friendfeed.png"); }
.orkut-icon, .orkut-icon a		{ background-image: url("./styles/prosilver/imageset/en/share_on_buttons/shareon_orkut.gif"); }
.digg-icon, .digg-icon a		{ background-image: url("./styles/prosilver/imageset/en/share_on_buttons/shareon_digg.gif"); }
.myspace-icon, .myspace-icon a		{ background-image: url("./styles/prosilver/imageset/en/share_on_buttons/shareon_myspace.png"); }
.delicious-icon, .delicious-icon a	{ background-image: url("./styles/prosilver/imageset/en/share_on_buttons/shareon_delicious.gif"); }
.technorati-icon, .technorati-icon a	{ background-image: url("./styles/prosilver/imageset/en/share_on_buttons/shareon_technorati.png"); }
/* Share On 1.2.0 */
...
#cp-main .panel li.row {
	border-bottom-color: #b9c7c0;
	border-top-color: #F9F9F9;
}

ul.cplist {
	border-top-color: #b9c7c0;
}
...
.pm-panel-header,
#cp-main .pm-message-nav {
	border-bottom-color: #a8bbb1;
}

/* PM marking colours */
.pmlist li.pm_message_reported_colour, .pm_message_reported_colour {
	border-left-color: #bc572a;
	border-right-color: #bc572a;
}
...
.thumbnail span {
	position: absolute;
	background: #12A3EB url("./styles/prosilver/theme/images/bg_header.gif") repeat-x;
	padding: 4px;
	left: 0px;
	display: none;
	color: #FFF;
